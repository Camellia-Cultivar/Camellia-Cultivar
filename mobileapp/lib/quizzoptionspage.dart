      ...
      body: Center(
        child: Container(
          ...
          child: Column(
            ...
            children: [
              const Text("Quizzes", style: TextStyle(color: Color(0xFF064E3B), fontSize: 30)),
              SizedBox(
                height: 69,
                width: 260,
                child: TextButton(
                  ...
                  child: Text("Start New Quizz".toUpperCase(), style: const TextStyle(color: Colors.white, fontSize: 18, fontWeight: FontWeight.w300))
                ),
              ),
              SizedBox(
                height: 69,
