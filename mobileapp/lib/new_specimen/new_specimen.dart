...
class NewSpecimen extends State<NewSpecimenPage> {
              ...
              for (UpovSubcategory subCategory in category.characteristics)
                SmartSelect<String>.single(
                  ...
                  onChange: (selected) => setState(() =>
                      selectedValues[subCategory.id - 1] = selected.value),
  ...
  Future<List> waitForUpovs() async {
    var future = await api.getUpovCharacteristics();
    return future;
  }
  ...
  Widget build(BuildContext context) {
    ...
    // var upovs;
    // if (!one_call) {
    //   upovs = api.getUpovCharacteristics();
    //   one_call = true;
    // }

    // List getfromapi = waitForUpovs() as List;
    ...
    return Scaffold(
        ...
        body: Center(
            child: Container(
                ...
                margin: EdgeInsets.fromLTRB(screenSize.width / 15.7,
                    screenSize.height / 20.6, screenSize.width / 15.7, 0),
                ...
                child: SingleChildScrollView(
                  child: Column(children: <Widget>[
                    ...
                    Container(
                      ...
                      // child: upovs(context, getfromapi)),
