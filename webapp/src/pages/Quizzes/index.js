        ...
        <div className="">
            <div className="grid gap-3 sm:place-items-center grid-flow-row-dense md:place-items-start sm:grid-cols-1 md:grid-cols-5 text-neutral-900 py-10">
                ...
                <div className="grid col-span-3 mx-8">
                    ...
                    <span className="text-lg mt-5 ml-7">The more quizzes you answer correctly, the higher your reputation will get!</span>
                    <div className="ml-11"><StepList steps={steps}/></div>
                </div>
...
let steps = [
    ...
    {"id": 3, "content": 'It is possible to submit the answers even if you can not identify them all!'}
];
